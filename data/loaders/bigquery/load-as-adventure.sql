...
LOAD DATA OVERWRITE as_adventure.datecustom (pk_date TIMESTAMP, datekey INT64, year TIMESTAMP, year_name STRING, month TIMESTAMP, month_name STRING, month_of_year INT64, quarter TIMESTAMP, quarter_name STRING, quarter_of_year INT64, day_of_week INT64, day_of_month INT64, day_of_week_name STRING, week STRING, week_name STRING, week_of_year INT64, date_name STRING) FROM FILES (format = 'CSV', field_delimiter = '\t', null_marker = '(null)', skip_leading_rows = 1, uris = ['gs://atscale_tutorial_data/as_adventure/as_adventure_table_AS_ADVENTURE.datecustom.csv']);
